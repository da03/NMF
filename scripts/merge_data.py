...
if len(sys.argv) < 5:
    print 'Merge partitioned matrix data Si.txt generated by the Petuum NMF application'
    print ''
    print 'Usage: python %s <data-dirname> <data-format> <m> <n> [<output-dirname>]' % sys.argv[0]
    print ''
    print 'Output: 1 merged file in directory specified in <output-dirname>.'
    print ''
    print 'Params:'
    print ('<data-dirname>: The directory containing S matrices generated by NMF application, '
